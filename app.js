...
app.post("/v3/assignments", isAuth, async (req, res) => {
...
app.put("/v3/assignments/:id", isAuth, async (req, res, next) => {
...
app.get("/v3/assignments", isAuth, async (req, res, next) => {
...
app.get("/v3/assignments/:id", isAuth, async (req, res, next) => {
...
app.delete("/v3/assignments/:id", isAuth, async (req, res, next) => {
...
app.post("/v3/assignments/:id/submission", isAuth, async (req, res) => {
  try {
    const postCredentials = getUser(req.headers.authorization);
    const [email] = postCredentials.split(":");
    const user = await User.findOne({ where: { email } });
